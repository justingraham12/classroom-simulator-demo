...
const KpiItem: React.FC<KpiItemProps> = ({
                                             label, currentValue, startValue, baseStartValue, isCurrency, isPercentage, icon, colorClass, trendHigherIsBetter = true
                                         }) => {
    ...
    return (
        <div className={`p-3 md:p-4 rounded-lg bg-gray-700/60 shadow-md border border-gray-600/50 flex flex-col justify-between min-h-[90px]`}>
...
const KpiDisplay: React.FC<KpiDisplayProps> = ({teamName, currentRoundLabel, kpis}) => {
    ...
    return (
        <div className="p-3 md:p-4 bg-gray-800/80 backdrop-blur-sm text-white rounded-t-xl shadow-lg border-b border-gray-700">
