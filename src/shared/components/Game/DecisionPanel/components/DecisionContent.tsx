...
import { DecisionState, DecisionActions } from '../core/interaction/decisions'';
import InvestmentPanel from './InvestmentPanel';
import ChoicePanel from './ChoicePanel';
import DoubleDownPromptPanel from './DoubleDownPromptPanel';
import DoubleDownSelectPanel from './DoubleDownSelectPanel';
